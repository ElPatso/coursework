...
<div id="header">
    ...
    <div class="searchDiv">
        <form action="${contextPath}/search" method="post" class="search">
            <input path="searchRow" type="search" name="searchRow" id="textsearch" onkeyup="checkparam()"
    ...
    <div class="buttonsign">
        ...
        <security:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_LECTURER')">
            <a href="${contextPath}/createlot">
                <button>Make public.</button>
            </a>
        </security:authorize>

        <security:authorize access="hasRole('ROLE_ADMIN')">
            <a href="${contextPath}/editusers">
                <button>Edit Users</button>
            </a>
            <a href="${contextPath}/editcategory">
